...
Field = CTkComboBox(Mainframe, width=150, variable=FieldText, values= None)
Field.place(relx=0.05, rely=0.7)
...
def SavedData():
    ...
    try:
        ...
        GetDescription = Description.get()
